...
coronavirus_merged <- coronavirus %>% left_join(pop_data2019, by=c("country")) %>%
mutate(percent_cases = cases/SP.POP.TOTL)


```

New Plot using the normalized values
