...
country_data <- coronavirus %>%
  ...
  # joining webstats population data with country data
  ...
  #normalizing cumulative data by population
...
ggplot(data = country_data,
  ...
  geom_label_repel(nudge_y = .0001, direction = "y", hjust = .0001) + 
  # turn off legend
  guides(color = FALSE) +
  # use pretty colors
  ...
  labs(
    ...
    y = "Cumulative deaths per million normalized by population",
